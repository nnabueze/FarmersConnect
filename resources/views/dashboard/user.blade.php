            ...
            <div class="body">
                <form id="sign_in" method="POST" action"/admin">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="username" data-toggle="tooltip" data-placement="top" title="Enter email address" placeholder="Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
