...
<section>
  ...
  @else
      ...
      <form role="form" action="/dealer" method="POST">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="form-group">
                          ...
                          <input  maxlength="100" type="text" name="name_of_company" class="form-control" placeholder="Enter Name of Company"  />
                      </div>
                      <div class="form-group">
                          <label class="control-label">Company Email</label>
                          <input maxlength="100" type="text" name="company_email" class="form-control" placeholder="Enter Company Email address" />
                      </div>
                      <div class="form-group">
                          <label class="control-label">Company Phone</label>
                          <input maxlength="100" type="text" name="company_phone" class="form-control" placeholder="Enter Phone Number" />
                      </div>
                      <div class="form-group">
              ...
              <div class="col-xs-12">
                  <div class="col-md-12">
                      ...
                      <div class="form-group">
                          ...
                          <input maxlength="100" type="text" name="contact_person" class="form-control" placeholder="Enter Contact Person" />
                      </div>
                      <div class="form-group">
                          <label class="control-label">Phone Number</label>
                          <input maxlength="100" type="text" name="person_phone" class="form-control" placeholder="Enter Phone Number" />
                      </div>
                      <div class="form-group">
                          <label class="control-label">Email Address</label>
                          <input maxlength="100" type="text" name="person_email" class="form-control" placeholder="Enter Email Address" />
                      </div>
                      <div class="form-group">
                          <label class="control-label">Area of Agricultural Expertise</label>
                          <input maxlength="100" type="text" name="agricultural_expertise" class="form-control" placeholder="Enter Area of Agricultural Expertise" />
                      </div>
              ...
              <div class="col-xs-12">
                  <div class="col-md-12">
                      ...
                      <div class="form-group">
                          ...
                          <input maxlength="200" type="text" name="company_tin" class="form-control" placeholder="Enter Company TIN"  />
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input maxlength="100" name="account_number" type="text" class="form-control" placeholder="Enter Company Bank Account number" />
                      </div>
                      <div class="form-group">
